...
(def org "replikativ")
(def lib 'org.replikativ/briefkasten)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :basis basis
                :src-dirs ["src"]
                :scm {:url "https://github.com/replikativ/briefkasten"
                      :connection "scm:git:git://github.com/replikativ/briefkasten.git"
                      :developerConnection "scm:git:ssh://git@github.com/replikativ/briefkasten.git"
                      :tag (str "v" version)}
                :pom-data [[:description "Local IMAP mirror with datahike metadata, scriptum fulltext, and yggdrasil atomic versioning"]
                           [:url "https://github.com/replikativ/briefkasten"]
                           [:licenses
                            [:license
